...
public class CluePlayer extends Player {
	 ...
	 * 
	 */
	private static final long serialVersionUID = -7461820735017273081L;
	Room current;
	ClueGame game;
	CluePlayer next;
	...
	boolean isDead;
	boolean zqqr=false;
	public CluePlayer(ClueGame game,AbstractPlayer member) {
		super(member);
		this.game=game;
	}
		...
		super.registerListener((msg,type)->{
			...
			if(text.startsWith("我的卡片")) {
				...
				try {
					...
					sendPrivate("格式错误，正确格式：“假设 [凶手角色ID] [凶器卡号码]”");
				}
