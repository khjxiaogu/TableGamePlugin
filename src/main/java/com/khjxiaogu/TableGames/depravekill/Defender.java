...
import com.khjxiaogu.TableGames.depravekill.Behaviour.SkillBehaviour;
...
public class Defender extends Villager {
	static class PlayerDefenderBehaviour extends SkillBehaviour{
		...
		public boolean fireBehaviour() {
			...
			player.sendPrivate("结界术士，你可以保护一个人包括自己免于被他人接近，不能连续两次保护同一个人，请私聊选择保护的人，你有一分钟的考虑时间\n格式：“保护 qq号或者游戏号码”\n如：“保护 1”\n如果放弃保护，则无需发送任何内容，等待时间结束即可。");
	...
	public void onTurn() {
		...
		super.sendPrivate("结界术士，你可以保护一个人包括自己免于被他人接近，不能连续两次保护同一个人，请私聊选择保护的人，你有一分钟的考虑时间\n格式：“保护 qq号或者游戏号码”\n如：“保护 1”\n如果放弃保护，则无需发送任何内容，等待时间结束即可。");
