...
public class IdiomSolitare extends Game {
	/**
	 * 
	 */
	private static final long serialVersionUID = 8553092242688868357L;
	List<SolitarePlayer> user=new ArrayList<>();
	int cplayer;
	...
	public boolean addMember(AbstractUser mem) {
		...
		user.add(new SolitarePlayer(mem));
